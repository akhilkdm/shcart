            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="">Sell Adds</h1>
                        <a href="">Dashborad / <i>Sell Adds </i></a>
                    </div> 
                    <!-- Content Row -->
                    <div class="">
                        ...
                        <div class="">
                            <div class="card shadow ">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Sell Adds </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                     ...
                     <br>
                        <table class="table">
                            ...
                            <tbody id="job">
                                <?php
                                $i = 0;
                                $stmt = $admin -> ret("SELECT * FROM `products` WHERE `addcat` = 'sell' ORDER BY `p_id` DESC");
